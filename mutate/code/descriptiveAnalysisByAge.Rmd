...
**White**
``` {r}
vcd::Kappa(table(medAdherence_wide_white$morisky_score_format_dich, medAdherence_wide_white$pilot_medadh_format_8_reg_bv2))
```

**Black**
``` {r}
vcd::Kappa(table(medAdherence_wide_black$morisky_score_format_dich, medAdherence_wide_black$pilot_medadh_format_8_reg_bv2))
```
